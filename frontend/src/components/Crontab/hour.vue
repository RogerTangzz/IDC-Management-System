...
watch(cycle01, () => { cycle01.value = props.check(cycle01.value, 0, 22) })
watch([cycle02, cycle01], () => { cycle02.value = props.check(cycle02.value, cycle01.value + 1, 23) })
watch(average01, () => { average01.value = props.check(average01.value, 0, 22) })
watch([average02, average01], () => { average02.value = props.check(average02.value, 1, 23 - average01.value) })
