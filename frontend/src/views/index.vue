...
.home {
  ...
  .ticket-summary-row { margin-bottom: 16px; }
  .ticket-summary-card { text-align:center; }
  .ticket-summary-card .meta { padding:6px 0; }
  .ticket-summary-card .value { font-size:28px; font-weight:600; line-height:1.2; }
  .ticket-summary-card .label { font-size:14px; color:#666; }
}
</style>
