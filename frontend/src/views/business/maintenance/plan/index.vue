  ...
  <div class="app-container">
    ...
    <el-form :model="queryParams" ref="queryRef" :inline="true" v-show="showSearch" label-width="80px">
      ...
      <el-form-item :label="$t('business.maintenance.field.floor')" prop="floor">
        <el-select v-model="queryParams.floor" :placeholder="$t('business.maintenance.placeholder.selectFloor')" clearable style="width: 200px">
      ...
      <el-form-item :label="$t('business.maintenance.field.mopCategory')" prop="mopCategory">
        <el-select v-model="queryParams.mopCategory" :placeholder="$t('business.maintenance.placeholder.selectCategory')" clearable style="width: 200px">
      ...
      <el-form-item :label="$t('business.maintenance.field.approvalStatus')" prop="approvalStatus">
        <el-select v-model="queryParams.approvalStatus" :placeholder="$t('business.maintenance.placeholder.selectStatus')" clearable style="width: 200px">
      ...
      <el-form-item :label="$t('business.maintenance.field.executionStatus')" prop="executionStatus">
        <el-select v-model="queryParams.executionStatus" :placeholder="$t('business.maintenance.placeholder.selectStatus')" clearable style="width: 200px">
